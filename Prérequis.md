...
Si vous avez ce message ![Image](/Images/Pasted_image_20231031154108.png)
...
ensuite, ouvrez le menu windows et tapez `env` ça devrait vous proposez `Modifier les variables d'environnement système`![Image](/Images/Pasted_image_20231031161140.png)
